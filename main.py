...
try: app_id = int(os.environ.get("app_id", "24935727"))
except Exception as app_id: print(f"⚠️ App ID Invalid {app_id}")
try: api_hash = os.environ.get("api_hash", "3fd33336629324ecd664e9b6894f0909")
except Exception as api_id: print(f"⚠️ Api Hash Invalid {api_hash}")
try: bot_token = os.environ.get("bot_token", "7307382466:AAEjQJy7e8wWreDozxcKn4VFVkLT8B0Cuhw")
except Exception as bot_token: print(f"⚠️ Bot Token Invalid {bot_token}")
try: custom_caption = os.environ.get("custom_caption", "`• <b>•Join Us {file_name}</b><b>╔════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╗</b><b>https://t.me/yamrajbackup</b><b>╚════ ᴊᴏɪɴ ᴡɪᴛʜ ᴜs ════╝</b>`")
...
start_message = """
<b>👋Hello {}</b>
<b>I am an SujayautoCaption bot</b>
<b>All you have to do is add me to your channel and I will show you my power</b>
<b>@onefighterarmy</b>"""

about_message = """
<b>• Name : <a href=https://t.me/sujay8371>VJ AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/sujay8371>[VJ UPDATES]</a></b>
...
def start_buttons(bot, update):
  bot = bot.get_me()
  buttons = [[
   pyrogram.types.InlineKeyboardButton("Updates", url="t.me/sujay8371"),
...
print("Bot Created By https://t.me/sujay5372")
